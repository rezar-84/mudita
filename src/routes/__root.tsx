...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Pacifico&family=Caveat:wght@400;700&family=Bungee&family=Montserrat:wght@500;700&family=Russo+One&family=Monoton&display=swap",
      },
    ],
  }),
