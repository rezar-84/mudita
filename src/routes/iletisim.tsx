...
function ContactPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12">
      ...
      <p className="mt-2 text-muted-foreground">Her türlü soru, özel sipariş ve teklif için bize ulaşın.</p>
        ...
        <div className="space-y-4">
          <a href="https://wa.me/" target="_blank" rel="noreferrer" className="flex items-center gap-3 rounded-2xl border border-border bg-card p-4 hover:bg-accent">
            ...
            <div>
              ...
              <div className="text-sm text-muted-foreground">Hızlı destek için tıklayın</div>
            </div>
          </a>
          ...
          <div className="flex items-center gap-3 rounded-2xl border border-border bg-card p-4">
            ...
            <div>
              ...
              <div className="text-sm text-muted-foreground">Hafta içi 09:00 - 18:00</div>
            </div>
          </div>
        </div>
